...
> This is my portfolio showing what I do as developer

**[portfolio]** is a website that shows someone biography..
...
Login to github or signuo if you dont have an account
...
After cloning the repository change the directory using 'cd Portfolio_' to access the files.
...
```sh
  cd my-folder
  git clone git@https://github.com/alphym/portfolio-project.git
```
...
If you like this project share it or give it a ⭐️
